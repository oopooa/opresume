...
export const schemas: ModuleSchema[] = [
  ...
  },
  {
    ...
    dataKey: 'x-op-publications',
    isList: true,
    titleKey: 'title',
    fields: [
      { key: 'title', labelKey: 'field.pubTitle', type: 'textarea' },
      { key: 'authors', labelKey: 'field.pubAuthors', type: 'textarea' },
      { key: 'selfAuthor', labelKey: 'field.pubSelfAuthor', type: 'text' },
      { key: 'venue', labelKey: 'field.pubVenue', type: 'text' },
      { key: 'year', labelKey: 'field.pubYear', type: 'text' },
      {
        key: 'category',
        labelKey: 'field.pubCategory',
        type: 'select',
        options: [
          { labelKey: 'field.pubCategoryFirst', value: 'first' },
          { labelKey: 'field.pubCategoryContributing', value: 'contributing' },
        ],
      },
      { key: 'doi', labelKey: 'field.pubDoi', type: 'text' },
      { key: 'url', labelKey: 'field.pubUrl', type: 'text' },
      { key: 'note', labelKey: 'field.pubNote', type: 'text' },
    ],
    defaultItem: () => ({ 'x-op-id': uid('pub'), title: '', authors: '', selfAuthor: '', venue: '', year: '', category: 'first', doi: '', url: '', note: '' }),
  },
  {
    module: 'grantList',
    dataKey: 'x-op-grants',
    ...
    titleKey: 'title',
    fields: [
      { key: 'title', labelKey: 'field.grantTitle', type: 'text' },
      { key: 'agency', labelKey: 'field.grantAgency', type: 'text' },
      { key: 'grantId', labelKey: 'field.grantId', type: 'text' },
      { key: 'role', labelKey: 'field.grantRole', type: 'text' },
      { key: 'total', labelKey: 'field.grantTotal', type: 'text' },
      { key: 'startDate', labelKey: 'field.grantTime', type: 'time-range', showPresent: true, endKey: 'endDate' },
    ],
    defaultItem: () => ({ 'x-op-id': uid('grant'), title: '', agency: '', grantId: '', role: '', total: '', startDate: '', endDate: '' }),
  },
  {
    module: 'posterList',
    dataKey: 'x-op-posters',
    isList: true,
    titleKey: 'title',
    fields: [
      { key: 'title', labelKey: 'field.pubTitle', type: 'textarea' },
    ...
    defaultItem: () => ({ 'x-op-id': uid('poster'), title: '', authors: '', selfAuthor: '', venue: '', year: '' }),
  },
  {
    module: 'teachingList',
    dataKey: 'x-op-teaching',
    isList: true,
    titleKey: 'name',
    fields: [
      { key: 'name', labelKey: 'field.teachingName', type: 'text' },
      { key: 'x-op-departmentName', labelKey: 'field.departmentName', type: 'text' },
      { key: 'x-op-advisor', labelKey: 'field.advisor', type: 'text' },
      { key: 'startDate', labelKey: 'field.workTime', type: 'time-range', showPresent: true, endKey: 'endDate' },
      { key: 'x-op-workDescHtml', labelKey: 'field.workDesc', type: 'markdown' },
    ],
    defaultItem: () => ({ 'x-op-id': uid('teach'), name: '', 'x-op-departmentName': '', 'x-op-advisor': '', startDate: '', endDate: '', 'x-op-workDescHtml': '' }),
  },
];
